...
describe('mathflow - evaluate', () => {
    ...
    test('built-in functions', () => {
        ...
        expect(evaluate(`log(100)`).value).toBeCloseTo(Math.log10(100));
        expect(evaluate(`sqrt(4)`).value).toBeCloseTo(Math.sqrt(4));

        expect(evaluate(`sin(30)`).value).toBeCloseTo(0.5);
        expect(evaluate(`cos(60)`).value).toBeCloseTo(0.5);
        expect(evaluate(`tan(45)`).value).toBeCloseTo(1);
    ...
    test('expansion', () => {
        ...
        expect(evaluate(`2log(100)`).value).toBe(2 * Math.log10(100));
        expect(evaluate(`2log(10*100)`).value).toBe(2 * Math.log10(10 * 100));
    });
